...
export class AddressAutocompleteField extends Component {
    ...
    setup() {
        ...
        onMounted(() => {
            ...
            if (typeof google !== 'undefined' && google.maps && google.maps.places) {
                ...
                this.initializeMap(parseFloat(latitude), parseFloat(longitude));
            } else {
                window.initMap = () => {
                    this.initializeAutocomplete();
            ...
            autocomplete.addListener('place_changed', async () => {
                ...
                if (place.geometry) {
                    ...
                    for (const component of addressComponents) {
                        ...
                        if (component.types.includes("latitude")) {
                            latitude = component.long_name;                           
                        } 
                        if (component.types.includes("longitude")) {
                            longitude = component.long_name;                           
                        } 
    ...
    initializeMap(lat, lng) {      
        ...
        // Create location object from lat and lng if both are present; otherwise, use the default location
        const location = (lat && lng) ? { lat: lat, lng: lng } : defaultLocation;
